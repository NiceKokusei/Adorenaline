...
# 指定模型输出的 .json 文件路径
result_file = '/home/wjb/lj/atelier/mmdetection2/work_dirs/coco_detection/test2.bbox.json'

# 指定保存可视化结果的文件夹
save_dir = '/home/wjb/lj/atelier/mmdetection2/work_dirs1/test-fasterrcnn'
